...
- Los archivos se pueden abrir directamente en el navegador sin necesidad de servidor web.
- No se usa el atributo `required` en ningún campo; todas las validaciones son manejadas por JavaScript.
- El sistema fue probado en Chrome y Firefox en resoluciones de escritorio y móvil.
- Se recomienda validar los archivos HTML y CSS en los validadores del W3C antes de la corrección final.